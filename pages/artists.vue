<template>
  <main>
    <musicpreview v-for="artist in filteredArtists" :link="'/albums?artist=' + artist.id" :name="artist.name" :imageurls="grabArtistImage(artist)" class="item" v-bind:key="artist.id"/>
  </main>
</template>
